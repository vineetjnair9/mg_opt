...
parpool('local',4);
poolobj = gcp;
addAttachedFiles(poolobj,{'irradiance.mat','temp.mat','wind_speed.mat','Load_day.mat'})
...
% Handle battery operations separately since parfor loop iterations must be independent
% DE_ON variable can also introduce potential dependencies between iterations
for t = 1:1:24
