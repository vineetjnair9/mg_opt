function [cost, soc_LI, DPSP, P_dump, P_lost, P_load, P_w, P_s, P_RES] = Dispatch_obj_LI_DE_v2(P_DE, P_b_LI)
...
load('load_shift_v2.mat'); % Hourly power (kW) demand profile for a single representative day
...
Costs = [COE/COE_base Emissions Dump 1-REF];
w = [0.25 0.25 0.25 0.25]; % Weights of different cost terms
cost = Costs * w';
