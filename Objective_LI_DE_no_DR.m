...
Emissions_base = CO2 + CO + NOx + SO2 + VOC + PM + PM10 + PM25;
...
%     end
    ...
    % Alternatively, can model assume fuel consumption cost to be quaratic
    % function of DE power output (Parisio et al. 2014 and others)
...
Emissions = (CO2 + CO + NOx + SO2 + VOC + PM + PM10 + PM25)/Emissions_base; % Always lies between 0 and 1
